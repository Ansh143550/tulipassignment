...
A modern, full-stack project management web application built for teams. Features role-based access control, real-time status tracking, Kanban boards, and a responsive dynamic user interface.

**Live Demo:** [https://tulip-project-manager-2024-production.up.railway.app](https://tulip-project-manager-2024-production.up.railway.app)
